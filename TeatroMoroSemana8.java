...
public class TeatroMoroSemana8 {
    ...
    public static void añadirAlCarrito(int id, String nombre, String sector, int asiento, int fila, String tarifa, double precioBase, double precioFinal) {
    ...
    public static void añadirAlCarritoReserva(int id, String nombre, String sector, int asiento, int fila, String tarifa, double precioBase, double precioFinal) {
            ...
            switch (opcionMenu) {
                        ...
                        switch (opcionMenu) {
                            case 1 -> {
                                ...
                                while (entradasConfirmadas < entradasSolicitadas) {
                                    ...
                                    añadirAlCarrito(idCliente, nombreCliente, sectorVip, asientoSeleccionado, filaSeleccionada, tarifaSeleccionada, precioVip, totalValorEntradaSeleccionada);
                            ...
                            case 2 -> {
                                ...
                                while (entradasConfirmadas < entradasSolicitadas) {
                                    ...
                                    añadirAlCarrito(idCliente, nombreCliente, PlateaBaja, asientoSeleccionado, filaSeleccionada, tarifaSeleccionada, precioPlateaBaja, totalValorEntradaSeleccionada);
                            ...
                            case 3 -> {
                                ...
                                while (entradasConfirmadas < entradasSolicitadas) {
                                    ...
                                    añadirAlCarrito(idCliente, nombreCliente, PlateaAlta, asientoSeleccionado, filaSeleccionada, tarifaSeleccionada, precioPlateaAlta, totalValorEntradaSeleccionada);
                        ...
                        switch (opcionMenu) {
                            case 1 -> {
                                ...
                                while (entradasConfirmadas < entradasSolicitadas) {
                                    ...
                                    añadirAlCarritoReserva(idCliente, nombreCliente, sectorVip, asientoSeleccionado, filaSeleccionada, tarifaSeleccionada, precioVip, totalValorEntradaSeleccionada);
                            ...
                            case 2 -> {
                                ...
                                while (entradasConfirmadas < entradasSolicitadas) {
                                    ...
                                    añadirAlCarritoReserva(idCliente, nombreCliente, PlateaBaja, asientoSeleccionado, filaSeleccionada, tarifaSeleccionada, precioPlateaBaja, totalValorEntradaSeleccionada);
                            ...
                            case 3 -> {
                                ...
                                while (entradasConfirmadas < entradasSolicitadas) {
                                    ...
                                    añadirAlCarritoReserva(idCliente, nombreCliente, PlateaAlta, asientoSeleccionado, filaSeleccionada, tarifaSeleccionada, precioPlateaAlta, totalValorEntradaSeleccionada);
                ...
                case 4 -> {
                    ...
                    do {
                        ...
                        System.out.println("Ingrese una opcion. 1 = Eliminar entradas, 2 = Editar entradas ,3 = confirmar reservas, 4 = Pagar, 5 = Salir al Menu Principal");
                        opcionMenu = sc.nextInt();
                        ...
                        switch (opcionMenu) {
                            ...
                            case 2 -> {
                                System.out.println("Has seleccionado 'Editar entradas'.");

                                System.out.println("Que numero de entrada deseas editar? " + historialNombreCliente.size() + "): ");
                                opcionEditarEntrada = sc.nextInt();
                                sc.nextLine();
                                if (opcionEditarEntrada >= 0 && opcionEditarEntrada <= historialNombreCliente.size()) {
                                    System.out.println("que desea editar?" + saltoDeLinea
                                    ...
                                    switch (opcionMenu) {
                                        case 1 -> {
                                            System.out.println("Está a punto de reemplazar: " + historialIdCliente.get(opcionEditarEntrada-1) + "Escriba el nombre por el que desea remplazar.");
                                            nuevoNombre = sc.nextLine();
                                            historialNombreCliente.set(opcionEditarEntrada-1, nuevoNombre);
                                            System.out.println("El nombre se ha cambiado con exito.");
                                        }
                                        case 2 -> {
                                            System.out.println("Ha seleccionado reemplazar asientos...");
                                                    liberarAsiento(
                                            ...
                                            if (historialTipoDeEntrada.get(opcionEditarEntrada - 1).equals("Sector VIP")) {
                                                seleccionarAsiento(sc, filasVip, asientosVip, filaVip1, filaVip2, filaVip3);
                                                historialFilas.set(opcionEditarEntrada - 1, filaSeleccionada);
                                                historialAsientos.set(opcionEditarEntrada - 1, asientoSeleccionado);
                                                break;
                                            } else if (historialTipoDeEntrada.get(opcionEditarEntrada - 1).equals("Platea Baja")) {
                                                seleccionarAsiento(sc, filasPlateaBaja, asientosPlateaBaja, filaPlateaBaja1, filaPlateaBaja2, filaPlateaBaja3);
                                                historialFilas.set(opcionEditarEntrada - 1, filaSeleccionada);
                                                historialAsientos.set(opcionEditarEntrada - 1, asientoSeleccionado);
                                                break;
                                            } else if (historialTipoDeEntrada.get(opcionEditarEntrada - 1).equals("Platea Alta")) {
                                                seleccionarAsiento(sc, filasPlateaAlta, asientosPlateaAlta, filaPlateaAlta1, filaPlateaAlta2, filaPlateaAlta3);
                                                historialFilas.set(opcionEditarEntrada - 1, filaSeleccionada);
                                                historialAsientos.set(opcionEditarEntrada - 1, asientoSeleccionado);
                                                break;
                                            }
                                ...
                                do {
                                    ...
                                    if (montoPago == totalCompras) {
                                        ...
                                        for (int k = 0; k < historialTipoDeEntrada.size(); k++) {
                                            ...
                                            System.out.println("Entrada Nro. " + historialIdCliente);
                                            System.out.println("Nombre Cliente:" + historialNombreCliente);
                                            ...
                                            System.out.println("Precio Original: " + historialPrecios.get(k));
